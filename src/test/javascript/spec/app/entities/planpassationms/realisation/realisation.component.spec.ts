...
import { RealisationComponent } from 'app/entities/planpassationms/realisation/realisation.component';
...
describe('Component Tests', () => {
  describe('Realisation Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.realisations && comp.realisations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
