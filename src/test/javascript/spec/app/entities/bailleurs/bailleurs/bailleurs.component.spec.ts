...
import { BailleursComponent } from 'app/entities/bailleurs/bailleurs/bailleurs.component';
...
describe('Component Tests', () => {
  describe('Bailleurs Management Component', () => {
    let comp: BailleursComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BailleursComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bailleurs && comp.bailleurs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
